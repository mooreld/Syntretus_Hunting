...
#'While loop' that reads each SRA accession line by line, downloads the given accession as split files, runs the split read files through bbmap and then deletes them when finished
